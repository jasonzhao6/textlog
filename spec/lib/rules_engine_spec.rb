...
describe RulesEngine do
  ...
  let(:json) { '{"name":"Biking","category":"Fitness","objective":"Butterlap","time":5400,"experience":"Felt engaged","reps":null,"friends":[{"name":"Scott Levy","fb_id":"ScottBLevy"},{"name":"Alan Fineberg","fb_id":"fineberg"},{"name":"Mary Ann Jawili","fb_id":"mjawili"}]}' }
  
  describe "#execute" do
    before(:each) do
      rules_engine.execute
    end
    specify { activity.to_json.should == json }
  end
