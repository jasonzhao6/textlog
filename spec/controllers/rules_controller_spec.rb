...
describe RulesController do
  describe "#create" do
    context "when there is one matcher and two setters" do
      ...
      let(:setter_command) { 'set_activity' }
      let(:setter_arg) { 'biking' }
      let(:setter2_command) { 'set_distance' }
      let(:setter2_arg) { { num: 5, unit: 'mi' } }
      let(:params) { { rule: { command:  matcher_command,
                       ...
                       args:     [ setter_arg,
                                   setter2_arg ] } }
      let(:rule_to_json) { '[{"command":"match","arg":"[regex]","cnt":0,"cnt_was_last_updated":false},{"command":"set_activity","arg":"biking","cnt":0,"cnt_was_last_updated":false,"matcher":{"matcher_id":null,"command":"match","arg":"[regex]","cnt":0,"cnt_was_last_updated":false}},{"command":"set_distance","arg":{"num":"5","unit":"mi"},"cnt":0,"cnt_was_last_updated":false,"matcher":{"matcher_id":null,"command":"match","arg":"[regex]","cnt":0,"cnt_was_last_updated":false}}]' }
      ...
      describe "#update" do
        context "when updating matcher arg and deleting 2nd setter" do
          ...
          let(:update_params) { { id: matcher.id,
                                  ...
                                  commands: [ setter_command ],
                                  args:     [ setter_arg ] } }
          let(:rule_to_json_updated) { '[{"command":"match","arg":"[regex2]","cnt":0,"cnt_was_last_updated":false},{"command":"set_activity","arg":"biking","cnt":0,"cnt_was_last_updated":false,"matcher":{"matcher_id":null,"command":"match","arg":"[regex2]","cnt":0,"cnt_was_last_updated":false}}]' }
